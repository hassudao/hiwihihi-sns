...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <nav className="
        /* スマホ：画面下部に固定 */
        fixed bottom-0 left-0 right-0 h-16 bg-white dark:bg-black border-t border-gray-200 dark:border-gray-800 z-50 flex flex-row justify-around items-center
        /* PC：左側に固定 (sm以上) */
        sm:sticky sm:top-0 sm:left-0 sm:h-screen sm:w-20 md:w-64 sm:flex-col sm:justify-between sm:p-4 sm:border-r sm:border-t-0
        transition-colors
      ">
        {/* メインリンク群 */}
